...
HD_PWD='C:/Users/jeeva/Documents/lab5_new/lab5_new.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log slc3_sramtop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source slc3_sramtop.tcl -notrace
